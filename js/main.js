...
jQuery(function($) {
  ...
  counter();
  jarallaxPlugin();
  // FIX: Removed contactForm() — form is now handled by the inline Formspree script in index.html
  stickyFillPlugin();
  animateReveal();

});

// FIX: Renamed siteIstotope → siteIsotope (was a typo in the original)
...
var mobileToggleClick = function() {
  ...
  // FIX: "outisde" typo in comment fixed (was original code comment)
